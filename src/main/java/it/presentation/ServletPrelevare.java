...
/**
 * Servlet implementation class ServletPrelevare
 */
public class ServletPrelevare extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private String message;
       
	@EJB
    IntestatarioEJB contoService;
    public ServletPrelevare() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Double preleva = Double.valueOf(request.getParameter("preleva"));
		
		if(contoService.controllaOperazione("prelievo", id, PIN, preleva)) {
		contoService.preleva(id, PIN, preleva);
		message = "<!DOCTYPE html>" +
			...
			message += "<div class=\"container col-md-4 mt-5 col-md-offset-4 justify-content-center text-center\"><div class=\"card\" style=\"width: 18rem;\">\r\n"
					...
					+ "    <p class=\"card-text h2 text-info\">Prelievo di "+ preleva +" euro effettuato!</p>\r\n"    
					+ "  </div>\r\n"
					+ "</div></div>";
		} else {
			message = "<!DOCTYPE html>" +
